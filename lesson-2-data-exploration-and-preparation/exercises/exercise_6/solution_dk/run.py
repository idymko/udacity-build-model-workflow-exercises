...
def go(args):
    ...
    logger.info("Create a wandb run for exercise_6")
    ...
    logger.info("Read data as pandas dataframe")
    df = pd.read_csv(artifact_path, low_memory=False)

    logger.info("Split model_dev/test")
    logger.info("Splitting data into train and test")
    splits = {}

    # test_size =   is used to make split reproducable 
    # stratify =     maintain same distribution in both splits
