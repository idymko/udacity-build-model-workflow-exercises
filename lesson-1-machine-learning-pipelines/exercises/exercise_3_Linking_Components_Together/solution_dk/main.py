...
# This automatically reads in the configuration from config.yaml
# and makes it available as the `config` variable.
# You can access the parameters using `config["section"]["parameter_name"]`
...
def go(config: DictConfig):
    ...
    # (needs to be used when you use hydra)
    ...
    _ = mlflow.run(
        ...
        parameters={
            ...
            "artifact_description": "data after proprocessing"
        }
    )
